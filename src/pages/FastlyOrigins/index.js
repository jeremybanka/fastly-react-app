...
import FastlyOriginsCharts from "./Charts";
...
type Props = {};
function FastlyOriginsPage(props: Props): React.Node {
    ...
    return (
      <Verify query={{ active_services_only: true }}>
        {(rsrc) => {
          ...
          return <Redirect to={`/origins/${serviceIds[0]}`} />;
        }}
      </Verify>
    );
  }
...
export default FastlyOriginsPage;
