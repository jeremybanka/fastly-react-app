...
const permissions = {
  resources: [
    ...
    },
    {
      ...
      operations: [
        ...
        },
        {
          ...
          description: `Administrative actions on user (reset password, reset 2fa)`,
    ...
    },
    {
      ...
      operations: [
        ...
        },
        {
          ...
          description: `Allow user to change account type to developer or paying`,
          operation: `update`,
    ...
    },
    {
      ...
      description: `Secure and manage domains added to your services using your own certificates or one procured by Fastly.`,
      scope: `account`,
      operations: [
        {
          name: `view TLS`,
    ...
    },
    {
      resource: `metrics`,
      name: `Metrics`,
      description: `Fastly offers a variety of ways to report on the performance and activity of your services.`,
      scope: `account`,
      operations: [
        {
    ...
    },
    {
      ...
      description: `Stream logs to a variety of locations, including third-party services, for storage and analysis.`,
      scope: `service`,
      operations: [
        {
        ...
        },
        {
          ...
          operation: `crud`,
          description: `Ability to Create, Read, Update, and Destroy logging endpoints`,
    ...
    },
    {
      ...
      operations: [
        ...
        },
        {
          ...
          description: `Allow user to view all configurations and stats of an existing Wasm service`,
          operation: `read`,
        ...
        },
        {
          ...
          description: `Allow user to edit an existing Wasm service, which requires a clone operation`,
          operation: `update`,
        ...
        },
        {
          ...
          description: `Allow user to Activate or Deactivate an existing Wasm service`,
          operation: `deploy`,
    ...
    },
    {
      ...
      description: `Log Tailing, stream log messages locally to your Fastly CLI`,
      scope: `service`,
      operations: [
        {
          name: `Create Log Tailing endpoint`,
          description: `Allows users to create Log Tailing endpoint (handled behind the scenes by EventBuffer)`,
          operation: `create`,
        ...
        },
        {
          ...
          description: `Allow user to view all logs streamed to Lot Tailing endpoint`,
          operation: `read`,
        ...
        },
        {
          ...
          description: `User are not allowed to edit Lot Tailing managed endpoint`,
          operation: `update`,
        ...
        },
        {
          ...
          description: `Allow user to delete an Log Tailing endpoint (handled behind the scenes by EventBuffer, similar to deactivating the endpoint`,
          operation: `delete`,
        ...
        },
        {
          ...
          description: `Allow user to Activate or Deactivate the Log Tailing endpoint`,
          operation: `deploy`,
      ...
      operations: [
        {
          ...
          description: `Allow user to add new roles, service groups, and user groups`,
          operation: `create`,
        ...
        },
        {
          ...
          description: `Allow user to assign and change roles, service groups, and user groups`,
          operation: `update`,
        ...
        },
        {
          ...
          description: `Allow user to delete roles, service groups, and user groups`,
          operation: `delete`,
    ...
    },
    {
      ...
      operations: [
        ...
        },
        {
          ...
          description: `Access for configuring services, including their versionless data structures such as Edge Dictionaries and Access Control Lists`,
          operation: `write`,
        ...
        },
        {
          ...
          description: `Access to compare differences between two service versions`,
          operation: `compare`,
    ...
    },
    {
      ...
      operations: [
        {
          name: `Purge`,
          description: `Access to remove, or mark as stale, a service's objects from Fastly caches.`,
          operation: `manage`,
      ...
      operations: [
        {
          ...
          description: `Access to view and download the service's Varnish Configuration Language (VCL) configuration file(s)`,
          operation: `read`,
